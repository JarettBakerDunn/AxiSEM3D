...
class Material {
  ...
  void
  getPointwiseRhoVpVs(axisem3d::eigen::arN_DColX& rho, axisem3d::eigen::arN_DColX& vp, axisem3d::eigen::arN_DColX& vs) const;
  ...
  evolveISO_TISO() {
    ...
    // eta
    mProperties.insert(
        {"ETA", NodalPhysicalProperty(axisem3d::eigen::DRow4::Ones(), mProperties.at("RHO").axial())});
    // erase vp, vs
