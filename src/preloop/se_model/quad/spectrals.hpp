...
namespace spectrals {
  ...
  // point positions
  // GLL
  const axisem3d::eigen::DColP gPositionsGLL = Eigen::Map<const axisem3d::eigen::DColP>(internal::pGLL.data());
  // GLJ
  const axisem3d::eigen::DColP gPositionsGLJ = Eigen::Map<const axisem3d::eigen::DColP>(internal::pGLJ.data());

  // weights
  // GLL
  const axisem3d::eigen::DColP gWeightsGLL = Eigen::Map<const axisem3d::eigen::DColP>(internal::wGLL.data());
  // GLJ
  const axisem3d::eigen::DColP gWeightsGLJ = Eigen::Map<const axisem3d::eigen::DColP>(internal::wGLJ.data());

  // G matrix
  // GLL
  const axisem3d::eigen::DMatPP_RM gGMatrixGLL = Eigen::Map<const axisem3d::eigen::DMatPP_RM>(internal::gGLL.data());
  // GLJ
  const axisem3d::eigen::DMatPP_RM gGMatrixGLJ = Eigen::Map<const axisem3d::eigen::DMatPP_RM>(internal::gGLJ.data());
