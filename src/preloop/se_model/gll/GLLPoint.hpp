...
class GLLPoint {
  ...
  addClaytonABC(const std::string& key,
    ...
    mClaytonABC.insert(
        {key, std::vector<std::tuple<bool, axisem3d::eigen::DMatX3, axisem3d::eigen::DColX, axisem3d::eigen::DColX>>()});
  ...
  std::map<std::string, std::vector<std::tuple<bool, axisem3d::eigen::DMatX3, axisem3d::eigen::DColX, axisem3d::eigen::DColX>>>
      mClaytonABC;
