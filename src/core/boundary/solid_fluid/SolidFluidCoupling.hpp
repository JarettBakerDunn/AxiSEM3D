...
class SolidFluidCoupling {
  ...
  // solid => fluid
  virtual void
  coupleSolidToFluid(const axisem3d::eigen::CMatX3& solidDispl, axisem3d::eigen::CColX& fluidStiff) const = 0;

  // fluid => solid
  virtual void
  coupleFluidToSolid(const axisem3d::eigen::CColX& fluidStiff, axisem3d::eigen::CMatX3& solidStiff) const = 0;
