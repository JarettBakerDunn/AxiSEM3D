...
class SolidFluidCoupling3D : public SolidFluidCoupling {
  ...
  // solid => fluid
  void
  coupleSolidToFluid(const axisem3d::eigen::CMatX3& solidDispl, axisem3d::eigen::CColX& fluidStiff) const;

  // fluid => solid
  void
  coupleFluidToSolid(const axisem3d::eigen::CColX& fluidStiff, axisem3d::eigen::CMatX3& solidStiff) const;
