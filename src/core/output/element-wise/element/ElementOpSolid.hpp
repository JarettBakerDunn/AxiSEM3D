...
class ElementOpSolid : public ElementOp {
  ...
  // making real
  inline static axisem3d::eigen::RMatXN3_RM sRUXN3 = axisem3d::eigen::RMatXN3_RM(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN9_RM sRGXN9 = axisem3d::eigen::RMatXN9_RM(0, spectral::nPEM * 9);
  inline static axisem3d::eigen::RMatXN6_RM sREXN6 = axisem3d::eigen::RMatXN6_RM(0, spectral::nPEM * 6);
  inline static axisem3d::eigen::RMatXN3_RM sRRXN3 = axisem3d::eigen::RMatXN3_RM(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN6_RM sRSXN6 = axisem3d::eigen::RMatXN6_RM(0, spectral::nPEM * 6);
};
