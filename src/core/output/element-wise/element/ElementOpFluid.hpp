...
class ElementOpFluid : public ElementOp {
  ...
  // making real
  inline static axisem3d::eigen::RMatXN_RM sRXXN1 = axisem3d::eigen::RMatXN_RM(0, spectral::nPEM * 1);
  inline static axisem3d::eigen::RMatXN3_RM sRUXN3 = axisem3d::eigen::RMatXN3_RM(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN_RM sRPXN1 = axisem3d::eigen::RMatXN_RM(0, spectral::nPEM * 1);
  inline static axisem3d::eigen::RMatXN_RM sRDXN1 = axisem3d::eigen::RMatXN_RM(0, spectral::nPEM * 1);
};
