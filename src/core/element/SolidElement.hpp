...
class SolidElement : public Element {
  ...
  // measure cost
  double
  measure(int count) const;

  /////////////////////////// source ///////////////////////////
  // prepare force source (force given in SPZ)
  void
  prepareForceSource() const;
  ...
  void
  prepareWavefieldOutput(const channel::solid::ChannelOptions& chops, bool enforceCoordTransform);
  ...
  // cardinal
  inline static axisem3d::eigen::RMatXN9 sStrainSpherical_CD = axisem3d::eigen::RMatXN9(0, spectral::nPEM * 9);
  inline static axisem3d::eigen::RMatXN6 sStrainUndulated_CD = axisem3d::eigen::RMatXN6(0, spectral::nPEM * 6);
  inline static axisem3d::eigen::RMatXN6 sStressUndulated_CD = axisem3d::eigen::RMatXN6(0, spectral::nPEM * 6);
  inline static axisem3d::eigen::RMatXN9 sStressSpherical_CD = axisem3d::eigen::RMatXN9(0, spectral::nPEM * 9);
};
