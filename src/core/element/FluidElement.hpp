...
class FluidElement : public Element {
  ...
  void
  prepareWavefieldOutput(const channel::fluid::ChannelOptions& chops, bool enforceCoordTransform);
  ...
  // cardinal
  inline static axisem3d::eigen::RMatXN3 sStrainSpherical_CD = axisem3d::eigen::RMatXN3(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN3 sStrainUndulated_CD = axisem3d::eigen::RMatXN3(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN3 sStressUndulated_CD = axisem3d::eigen::RMatXN3(0, spectral::nPEM * 3);
  inline static axisem3d::eigen::RMatXN3 sStressSpherical_CD = axisem3d::eigen::RMatXN3(0, spectral::nPEM * 3);
};
