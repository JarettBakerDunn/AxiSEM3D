...
class Attenuation {
  ...
  virtual void
  apply(const axisem3d::eigen::vec_ar6_CMatPP_RM& strain, axisem3d::eigen::vec_ar6_CMatPP_RM& stress, int nu_1) = 0;
  ...
  static void
  setAlphaBetaGamma(
      const axisem3d::eigen::DColX& alpha, const axisem3d::eigen::DColX& betta, const axisem3d::eigen::DColX& gamma) {
