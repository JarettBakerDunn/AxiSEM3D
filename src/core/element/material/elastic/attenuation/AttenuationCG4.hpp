...
class AttenuationCG4 : public Attenuation {
  ...
  void
  apply(const axisem3d::eigen::vec_ar6_CMatPP_RM& strain, axisem3d::eigen::vec_ar6_CMatPP_RM& stress, int nu_1) {
#ifdef AXISEM3D_SAVE_MEMORY
    computeDMu2();
#endif
    for (int alpha = 0; alpha < nu_1; alpha++) {
  ...
  // CASE == _1D_FR
  static void
  formStrain4(const axisem3d::eigen::vec_ar6_CMatPP_RM& strainN, axisem3d::eigen::vec_ar6_CMat22_RM& strain4, int nx) {
    for (int idim = 0; idim < 6; idim++) {
