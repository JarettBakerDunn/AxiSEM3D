...
class Elastic {
  ...
  virtual void
  strainToStress_FR(
      const axisem3d::eigen::vec_ar6_CMatPP_RM& strain, axisem3d::eigen::vec_ar6_CMatPP_RM& stress, int nu_1) const = 0;

  // strain => stress in cardinal space
  virtual void
  strainToStress_CD(const axisem3d::eigen::RMatXN6& strain, axisem3d::eigen::RMatXN6& stress, int nr) const = 0;
  ...
  void
  applyAttenuation(
      const axisem3d::eigen::vec_ar6_CMatPP_RM& strain, axisem3d::eigen::vec_ar6_CMatPP_RM& stress, int nu_1) const {
    if (mAttenuation) {
  ...
  void
  applyAttenuation(const axisem3d::eigen::RMatXN6& strain, axisem3d::eigen::RMatXN6& stress, int nr) const {
    if (mAttenuation) {
