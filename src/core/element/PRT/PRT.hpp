...
class PRT {
  ...
  PRT(const axisem3d::eigen::DMatPP_RM& X0,
      ...
      const axisem3d::eigen::DMatPP_RM& XJ) : m1D(true), mX0(X0), mX1(X1), mX2(X2), mX3(X3), mXJ(XJ) {
    // noting
  }
  ...
  PRT(const axisem3d::eigen::DMatPP_RM& X0,
      ...
      m1D(true), mX0(X0), mX1(X1), mX2(X2), mX3(X3), mX0_J(axisem3d::eigen::DMatPP_RM(X0.cwiseProduct(XJ))),
      mX1_J(axisem3d::eigen::DMatPP_RM(X1.cwiseProduct(XJ))), mX2_J(axisem3d::eigen::DMatPP_RM(X2.cwiseProduct(XJ))),
  ...
  PRT(const axisem3d::eigen::DMatXN& X0,
      ...
      m1D(false), mX0(X0), mX1(X1), mX2(X2), mX3(X3), mX0_J(axisem3d::eigen::DMatXN(X0.cwiseProduct(XJ))),
      mX1_J(axisem3d::eigen::DMatXN(X1.cwiseProduct(XJ))), mX2_J(axisem3d::eigen::DMatXN(X2.cwiseProduct(XJ))),
  ...
  sphericalToUndulated3_FR(
      const axisem3d::eigen::vec_ar3_CMatPP_RM& sph3, axisem3d::eigen::vec_ar3_CMatPP_RM& und3, int nu_1) const {
  ...
  sphericalToUndulated6_FR(
      const axisem3d::eigen::vec_ar9_CMatPP_RM& sph9, axisem3d::eigen::vec_ar6_CMatPP_RM& und6, int nu_1) const {
    for (int alpha = 0; alpha < nu_1; alpha++) {
  ...
  sphericalToUndulated9_FR(
      const axisem3d::eigen::vec_ar9_CMatPP_RM& sph9, axisem3d::eigen::vec_ar9_CMatPP_RM& und9, int nu_1) const {
    for (int alpha = 0; alpha < nu_1; alpha++) {
  ...
  undulatedToSpherical3_FR(
      const axisem3d::eigen::vec_ar3_CMatPP_RM& und3, axisem3d::eigen::vec_ar3_CMatPP_RM& sph3, int nu_1) const {
#ifdef AXISEM3D_SAVE_MEMORY
    computeScaledX();
#endif
    for (int alpha = 0; alpha < nu_1; alpha++) {
  ...
  undulatedToSpherical6_FR(
      const axisem3d::eigen::vec_ar6_CMatPP_RM& und6, axisem3d::eigen::vec_ar9_CMatPP_RM& sph9, int nu_1) const {
#ifdef AXISEM3D_SAVE_MEMORY
    computeScaledX();
#endif
    for (int alpha = 0; alpha < nu_1; alpha++) {
  ...
  // fluid, sph -> und
  void
  sphericalToUndulated3_CD(const axisem3d::eigen::RMatXN3& sph3, axisem3d::eigen::RMatXN3& und3, int nr) const {
    if (m1D) {
  ...
  // solid, sph -> und
  void
  sphericalToUndulated6_CD(const axisem3d::eigen::RMatXN9& sph9, axisem3d::eigen::RMatXN6& und6, int nr) const {
    if (m1D) {
  ...
  // solid, sph -> und, for curl computation (9->9)
  void
  sphericalToUndulated9_CD(const axisem3d::eigen::RMatXN9& sph9, axisem3d::eigen::RMatXN9& und9, int nr) const {
    if (m1D) {
  ...
  // fluid, und -> sph
  void
  undulatedToSpherical3_CD(const axisem3d::eigen::RMatXN3& und3, axisem3d::eigen::RMatXN3& sph3, int nr) const {
#ifdef AXISEM3D_SAVE_MEMORY
    computeScaledX();
#endif
    if (m1D) {
  ...
  // solid, und -> sph
  void
  undulatedToSpherical6_CD(const axisem3d::eigen::RMatXN6& und6, axisem3d::eigen::RMatXN9& sph9, int nr) const {
#ifdef AXISEM3D_SAVE_MEMORY
    computeScaledX();
#endif
    if (m1D) {
